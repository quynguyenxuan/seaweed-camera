...
func (vl *VolumeLayout) isOutdated(v *storage.VolumeInfo) bool {
	...
	// }
	return math.Floor(float64(currentTime/60)) > math.Floor(float64(v.ModifiedAtSecond/60)) && v.FileCount > 0
	// return math.Floor(float64(currentTime/3600)) > math.Floor(float64(v.ModifiedAtSecond/3600))
