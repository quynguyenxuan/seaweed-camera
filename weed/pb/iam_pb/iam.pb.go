...
type Credential struct {
	...
	Expiration uint64 `protobuf:"varint,3,opt,name=expiration,proto3" json:"expiration,omitempty"` // bool is_disabled = 4;
}
...
func (x *Credential) GetExpiration() uint64 {
	if x != nil {
		return x.Expiration
	}
	return 0
...
var file_iam_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6a, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69,
