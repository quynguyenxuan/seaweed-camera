...
type CollectionCleanupRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	DryRun        bool                   `protobuf:"varint,2,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"` // If true, only report what would be deleted without actually deleting
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CollectionCleanupRequest) Reset() {
	*x = CollectionCleanupRequest{}
	mi := &file_master_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CollectionCleanupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectionCleanupRequest) ProtoMessage() {}

func (x *CollectionCleanupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_master_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectionCleanupRequest.ProtoReflect.Descriptor instead.
func (*CollectionCleanupRequest) Descriptor() ([]byte, []int) {
	return file_master_proto_rawDescGZIP(), []int{25}
}

func (x *CollectionCleanupRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CollectionCleanupRequest) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
type CollectionCleanupResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DeletedFiles  int64                  `protobuf:"varint,1,opt,name=deleted_files,json=deletedFiles,proto3" json:"deleted_files,omitempty"` // Number of files deleted
	DeletedSize   int64                  `protobuf:"varint,2,opt,name=deleted_size,json=deletedSize,proto3" json:"deleted_size,omitempty"`    // Total size of deleted files in bytes
	Status        string                 `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`                                  // Status message
	VolumeIds     []string               `protobuf:"bytes,4,rep,name=volume_ids,json=volumeIds,proto3" json:"volume_ids,omitempty"`           // List of volume IDs that were processed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CollectionCleanupResponse) Reset() {
	*x = CollectionCleanupResponse{}
	mi := &file_master_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CollectionCleanupResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectionCleanupResponse) ProtoMessage() {}

func (x *CollectionCleanupResponse) ProtoReflect() protoreflect.Message {
	mi := &file_master_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectionCleanupResponse.ProtoReflect.Descriptor instead.
func (*CollectionCleanupResponse) Descriptor() ([]byte, []int) {
	return file_master_proto_rawDescGZIP(), []int{26}
}

func (x *CollectionCleanupResponse) GetDeletedFiles() int64 {
	if x != nil {
...
func (x *CollectionCleanupResponse) GetDeletedSize() int64 {
	if x != nil {
		return x.DeletedSize
	}
	return 0
}

func (x *CollectionCleanupResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *CollectionCleanupResponse) GetVolumeIds() []string {
	if x != nil {
		return x.VolumeIds
	}
	return nil
...
const file_master_proto_rawDesc = "" +
	...
	"\vcollections\x18\x01 \x03(\v2\x15.master_pb.CollectionR\vcollections\"c\n" +
	"\x17CollectionDeleteRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tfrom_time\x18\x02 \x01(\x04R\bfromTime\x12\x17\n" +
	"\ato_time\x18\x03 \x01(\x04R\x06toTime\"\x1a\n" +
	"\x18CollectionDeleteResponse\"G\n" +
	"\x18CollectionCleanupRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x17\n" +
	"\adry_run\x18\x02 \x01(\bR\x06dryRun\"\x9a\x01\n" +
	"\x19CollectionCleanupResponse\x12#\n" +
	"\rdeleted_files\x18\x01 \x01(\x03R\fdeletedFiles\x12!\n" +
	"\fdeleted_size\x18\x02 \x01(\x03R\vdeletedSize\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"volume_ids\x18\x04 \x03(\tR\tvolumeIds\"\xaa\x03\n" +
	"\bDiskInfo\x12\x12\n" +
	...
	"\x12VolumeGrowResponse2\xa8\x11\n" +
	"\aSeaweed\x12I\n" +
	...
	"\x10CollectionDelete\x12\".master_pb.CollectionDeleteRequest\x1a#.master_pb.CollectionDeleteResponse\"\x00\x12`\n" +
	"\x11CollectionCleanup\x12#.master_pb.CollectionCleanupRequest\x1a$.master_pb.CollectionCleanupResponse\"\x00\x12K\n" +
	"\n" +
...
var file_master_proto_goTypes = []any{
	...
	(*CollectionCleanupRequest)(nil),              // 25: master_pb.CollectionCleanupRequest
	(*CollectionCleanupResponse)(nil),             // 26: master_pb.CollectionCleanupResponse
...
var file_master_proto_depIdxs = []int32{
	...
	64, // 8: master_pb.StorageBackend.properties:type_name -> master_pb.StorageBackend.PropertiesEntry
	65, // 9: master_pb.SuperBlockExtra.erasure_coding:type_name -> master_pb.SuperBlockExtra.ErasureCoding
	...
	66, // 12: master_pb.LookupVolumeResponse.volume_id_locations:type_name -> master_pb.LookupVolumeResponse.VolumeIdLocation
	...
	67, // 18: master_pb.DataNodeInfo.diskInfos:type_name -> master_pb.DataNodeInfo.DiskInfosEntry
	28, // 19: master_pb.RackInfo.data_node_infos:type_name -> master_pb.DataNodeInfo
	68, // 20: master_pb.RackInfo.diskInfos:type_name -> master_pb.RackInfo.DiskInfosEntry
	29, // 21: master_pb.DataCenterInfo.rack_infos:type_name -> master_pb.RackInfo
	69, // 22: master_pb.DataCenterInfo.diskInfos:type_name -> master_pb.DataCenterInfo.DiskInfosEntry
	30, // 23: master_pb.TopologyInfo.data_center_infos:type_name -> master_pb.DataCenterInfo
	70, // 24: master_pb.TopologyInfo.diskInfos:type_name -> master_pb.TopologyInfo.DiskInfosEntry
	31, // 25: master_pb.VolumeListResponse.topology_info:type_name -> master_pb.TopologyInfo
	71, // 26: master_pb.LookupEcVolumeResponse.shard_id_locations:type_name -> master_pb.LookupEcVolumeResponse.EcShardIdLocation
	5,  // 27: master_pb.GetMasterConfigurationResponse.storage_backends:type_name -> master_pb.StorageBackend
	72, // 28: master_pb.ListClusterNodesResponse.cluster_nodes:type_name -> master_pb.ListClusterNodesResponse.ClusterNode
	73, // 29: master_pb.RaftListClusterServersResponse.cluster_servers:type_name -> master_pb.RaftListClusterServersResponse.ClusterServers
	14, // 30: master_pb.LookupVolumeResponse.VolumeIdLocation.locations:type_name -> master_pb.Location
	27, // 31: master_pb.DataNodeInfo.DiskInfosEntry.value:type_name -> master_pb.DiskInfo
	27, // 32: master_pb.RackInfo.DiskInfosEntry.value:type_name -> master_pb.DiskInfo
	27, // 33: master_pb.DataCenterInfo.DiskInfosEntry.value:type_name -> master_pb.DiskInfo
	27, // 34: master_pb.TopologyInfo.DiskInfosEntry.value:type_name -> master_pb.DiskInfo
	...
	25, // 44: master_pb.Seaweed.CollectionCleanup:input_type -> master_pb.CollectionCleanupRequest
	32, // 45: master_pb.Seaweed.VolumeList:input_type -> master_pb.VolumeListRequest
	34, // 46: master_pb.Seaweed.LookupEcVolume:input_type -> master_pb.LookupEcVolumeRequest
	...
	60, // 59: master_pb.Seaweed.RaftLeadershipTransfer:input_type -> master_pb.RaftLeadershipTransferRequest
	...
	26, // 69: master_pb.Seaweed.CollectionCleanup:output_type -> master_pb.CollectionCleanupResponse
	33, // 70: master_pb.Seaweed.VolumeList:output_type -> master_pb.VolumeListResponse
	35, // 71: master_pb.Seaweed.LookupEcVolume:output_type -> master_pb.LookupEcVolumeResponse
	37, // 72: master_pb.Seaweed.VacuumVolume:output_type -> master_pb.VacuumVolumeResponse
	39, // 73: master_pb.Seaweed.DisableVacuum:output_type -> master_pb.DisableVacuumResponse
	41, // 74: master_pb.Seaweed.EnableVacuum:output_type -> master_pb.EnableVacuumResponse
	43, // 75: master_pb.Seaweed.VolumeMarkReadonly:output_type -> master_pb.VolumeMarkReadonlyResponse
	45, // 76: master_pb.Seaweed.GetMasterConfiguration:output_type -> master_pb.GetMasterConfigurationResponse
	47, // 77: master_pb.Seaweed.ListClusterNodes:output_type -> master_pb.ListClusterNodesResponse
	49, // 78: master_pb.Seaweed.LeaseAdminToken:output_type -> master_pb.LeaseAdminTokenResponse
	51, // 79: master_pb.Seaweed.ReleaseAdminToken:output_type -> master_pb.ReleaseAdminTokenResponse
	53, // 80: master_pb.Seaweed.Ping:output_type -> master_pb.PingResponse
	59, // 81: master_pb.Seaweed.RaftListClusterServers:output_type -> master_pb.RaftListClusterServersResponse
	55, // 82: master_pb.Seaweed.RaftAddServer:output_type -> master_pb.RaftAddServerResponse
	57, // 83: master_pb.Seaweed.RaftRemoveServer:output_type -> master_pb.RaftRemoveServerResponse
	61, // 84: master_pb.Seaweed.RaftLeadershipTransfer:output_type -> master_pb.RaftLeadershipTransferResponse
	62, // 85: master_pb.Seaweed.VolumeGrow:output_type -> master_pb.VolumeGrowResponse
