...
type DeleteCollectionRequest struct {
	...
	// QUYNGUYEN
	VolumeIds     []uint32 `protobuf:"varint,4,rep,packed,name=volume_ids,json=volumeIds,proto3" json:"volume_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeleteCollectionRequest) GetVolumeIds() []uint32 {
	if x != nil {
		return x.VolumeIds
	}
	return nil
...
const file_filer_proto_rawDesc = "" +
	...
	"\vcollections\x18\x01 \x03(\v2\x14.filer_pb.CollectionR\vcollections\"\x8e\x01\n" +
	"\x17DeleteCollectionRequest\x12\x1e\n" +
	"\n" +
	"collection\x18\x01 \x01(\tR\n" +
	"collection\x12\x1b\n" +
	"\tfrom_time\x18\x02 \x01(\x04R\bfromTime\x12\x17\n" +
	"\ato_time\x18\x03 \x01(\x04R\x06toTime\x12\x1d\n" +
	"\n" +
	"volume_ids\x18\x04 \x03(\rR\tvolumeIds\"\x1a\n" +
