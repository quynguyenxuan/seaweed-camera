...
func (x *DeleteCollectionResponse) GetVolumeIds() []uint32 {
	if x != nil {
		return x.VolumeIds
	}
	return nil
...
const file_volume_server_proto_rawDesc = "" +
	...
	"\x1bVacuumVolumeCleanupResponse\"o\n" +
	"\x17DeleteCollectionRequest\x12\x1e\n" +
	"\n" +
	"collection\x18\x01 \x01(\tR\n" +
	"collection\x12\x1b\n" +
	"\tfrom_time\x18\x02 \x01(\x04R\bfromTime\x12\x17\n" +
	"\ato_time\x18\x03 \x01(\x04R\x06toTime\"9\n" +
	"\x18DeleteCollectionResponse\x12\x1d\n" +
	"\n" +
	"volume_ids\x18\x01 \x03(\rR\tvolumeIds\"\x95\x02\n" +
